...
// its own can be read the way this tool reads one.
...
// product loads a whole product the way this tool does: the runtime.yaml in a
...
// one thing this tool has to say that loading it never will.
...
// Both commands under test report by printing, which is the whole of what they
// do.
