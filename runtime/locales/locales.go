...
// file: copy runtime.pot to <code>.po, fill in the right-hand side, done.
...
//
// runtime.pot is the list those files are filled in from, and it is generated:
...
// failure report. Everything a module says about itself — variables, stages,
