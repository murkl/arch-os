...
# The share, and the discovery that makes Windows list this machine - on
# networks marked as home and nowhere else: a share on a café's wifi is a
# password anybody there can try.
