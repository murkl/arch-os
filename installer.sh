...
# ----------------------------------------------------------------------------------------------------
{
    ...
    echo ""
    echo "# Change to 'custom' to use custom language properties"
    ...
    echo ""
    echo "# find /usr/share/kbd/consolefonts/*.psfu.gz"
    echo "ARCH_VCONSOLE_FONT='${ARCH_VCONSOLE_FONT}'"
    echo ""
    echo "# localectl list-x11-keymap-layouts"
    echo "ARCH_KEYBOARD_LAYOUT='${ARCH_KEYBOARD_LAYOUT}'"
    echo ""
    echo "# localectl list-x11-keymap-variants"
